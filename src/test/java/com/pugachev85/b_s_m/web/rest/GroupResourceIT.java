...
import com.pugachev85.b_s_m.repository.GroupRepository;
...
class GroupResourceIT {
    ...
    public static Group createEntity(EntityManager em) {
        Group group = new Group().title(DEFAULT_TITLE).acceptanceDate(DEFAULT_ACCEPTANCE_DATE);
        return group;
    }
    ...
    public static Group createUpdatedEntity(EntityManager em) {
        Group group = new Group().title(UPDATED_TITLE).acceptanceDate(UPDATED_ACCEPTANCE_DATE);
        return group;
    }
    ...
    void createGroup() throws Exception {
        ...
        assertThat(testGroup.getAcceptanceDate()).isEqualTo(DEFAULT_ACCEPTANCE_DATE);
    }
    ...
    void putExistingGroup() throws Exception {
        ...
        updatedGroup.title(UPDATED_TITLE).acceptanceDate(UPDATED_ACCEPTANCE_DATE);
        ...
        assertThat(testGroup.getAcceptanceDate()).isEqualTo(UPDATED_ACCEPTANCE_DATE);
    }
    ...
    void partialUpdateGroupWithPatch() throws Exception {
        ...
        partialUpdatedGroup.title(UPDATED_TITLE);
    ...
    void fullUpdateGroupWithPatch() throws Exception {
        ...
        partialUpdatedGroup.title(UPDATED_TITLE).acceptanceDate(UPDATED_ACCEPTANCE_DATE);
