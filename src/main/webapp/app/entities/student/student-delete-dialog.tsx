...
export const StudentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="basicStudentsManagmentApp.student.delete.question">
        <Translate contentKey="basicStudentsManagmentApp.student.delete.question" interpolate={{ id: studentEntity.id }}>
