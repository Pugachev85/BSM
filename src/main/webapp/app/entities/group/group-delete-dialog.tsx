...
export const GroupDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="basicStudentsManagmentApp.group.delete.question">
        <Translate contentKey="basicStudentsManagmentApp.group.delete.question" interpolate={{ id: groupEntity.id }}>
