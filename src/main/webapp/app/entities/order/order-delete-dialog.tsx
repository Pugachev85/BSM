...
export const OrderDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="basicStudentsManagmentApp.order.delete.question">
        <Translate contentKey="basicStudentsManagmentApp.order.delete.question" interpolate={{ id: orderEntity.id }}>
