...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERSONALGRADE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PERSONALGRADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PERSONALGRADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PERSONALGRADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PERSONALGRADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PERSONALGRADE actions', async () => {
      const expectedActions = [
        {
