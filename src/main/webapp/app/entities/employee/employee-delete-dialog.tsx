...
export const EmployeeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="basicStudentsManagmentApp.employee.delete.question">
        <Translate contentKey="basicStudentsManagmentApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
