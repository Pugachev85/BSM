...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACADEMICSUBJECT_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACADEMICSUBJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACADEMICSUBJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACADEMICSUBJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACADEMICSUBJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACADEMICSUBJECT actions', async () => {
      const expectedActions = [
        {
