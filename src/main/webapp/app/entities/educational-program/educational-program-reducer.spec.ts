...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './educational-program.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EDUCATIONALPROGRAM_LIST actions', async () => {
    ...
    it('dispatches FETCH_EDUCATIONALPROGRAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EDUCATIONALPROGRAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EDUCATIONALPROGRAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EDUCATIONALPROGRAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EDUCATIONALPROGRAM actions', async () => {
      const expectedActions = [
        {
