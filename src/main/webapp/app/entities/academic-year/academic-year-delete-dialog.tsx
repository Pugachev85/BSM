...
export const AcademicYearDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="basicStudentsManagmentApp.academicYear.delete.question">
        <Translate contentKey="basicStudentsManagmentApp.academicYear.delete.question" interpolate={{ id: academicYearEntity.id }}>
