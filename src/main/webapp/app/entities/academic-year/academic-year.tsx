  ...
  return (
    <div>
      <h2 id="academic-year-heading" data-cy="AcademicYearHeading">
        <Translate contentKey="basicStudentsManagmentApp.academicYear.home.title">Academic Years</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="basicStudentsManagmentApp.academicYear.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/academic-year/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="basicStudentsManagmentApp.academicYear.home.createLabel">Create new Academic Year</Translate>
          </Link>
        </div>
      </h2>
        ...
        {academicYearList && academicYearList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="basicStudentsManagmentApp.academicYear.id">ID</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="basicStudentsManagmentApp.academicYear.home.notFound">No Academic Years found</Translate>
            </div>
          )
        )}
      </div>
