  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="basicStudentsManagmentApp.academicYear.home.createOrEditLabel" data-cy="AcademicYearCreateUpdateHeading">
            <Translate contentKey="basicStudentsManagmentApp.academicYear.home.createOrEditLabel">Create or edit a AcademicYear</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('basicStudentsManagmentApp.academicYear.title')}
