...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STUDYPLACE_LIST actions', async () => {
    ...
    it('dispatches FETCH_STUDYPLACE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STUDYPLACE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STUDYPLACE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STUDYPLACE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STUDYPLACE actions', async () => {
      const expectedActions = [
        {
