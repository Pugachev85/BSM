...
import com.pugachev85.b_s_m.repository.StudentRepository;
...
/**
 * REST controller for managing {@link com.pugachev85.b_s_m.domain.Student}.
 */
@RestController
...
public class StudentResource {
    ...
    public ResponseEntity<Student> partialUpdateStudent(
        ...
        Optional<Student> result = studentRepository
            ...
            .map(existingStudent -> {
                if (student.getAlphabetBookNumber() != null) {
                    existingStudent.setAlphabetBookNumber(student.getAlphabetBookNumber());
                }
