...
/**
 * REST controller for managing {@link com.pugachev85.b_s_m.domain.Group}.
 */
@RestController
    ...
    public ResponseEntity<Group> partialUpdateGroup(
        ...
        Optional<Group> result = groupRepository
            ...
            .map(existingGroup -> {
                ...
                if (group.getAcceptanceDate() != null) {
                    existingGroup.setAcceptanceDate(group.getAcceptanceDate());
                }
